...
$filtro = "&Id_Rubro=".$Id_Rubro."&Rubro=".$Rubro."&Id_SubRubro=".$Id_SubRubro."&SubRubro=".$SubRubro."&Pagina="."productos_subrubros_carro.php";
...
?>
<!DOCTYPE html>
<html lang="es"><!-- InstanceBegin template="/Templates/polirrubros.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
    ...
    <div class="container" style="background-color: #FFF;">
        ...
        <div class="row">
            <div align="center" class="col-md-12">
                <h2>PRODUCTOS en <?php echo $Rubro." | ".$SubRubro ?></h2>
            </div>
        </div>
        ...
        <div class="row">
            <div align="center" class="col-md-12">
                ...
                if ($pagina > 1)
                {
                    ...
                    $pag_ant = $pagina - 1;
                    echo "<a href='productos_subrubros_carro.php?pagina=$pag_ant&cant_reg=$cant_reg&cant_pag=$cant_pag&Buscar=Buscar&Id_Rubro=".$Id_Rubro."&Rubro=".$Rubro."&Id_SubRubro=".$Id_SubRubro."&SubRubro=".$SubRubro."'>
                ...
                if ($cant_pag >= $pagina)
                {
                    ...
                    echo "<a href='productos_subrubros_carro.php?pagina=$pagina&cant_reg=$cant_reg&cant_pag=$cant_pag&Buscar=Buscar&Id_Rubro=".$Id_Rubro."&Rubro=".$Rubro."&Id_SubRubro=".$Id_SubRubro."&SubRubro=".$SubRubro."'>
        ...
        <div class="row">
            <div align="center" class="col-md-12">
                <p>
                    ...
                    <a href="subrubros.php<?php echo "?Id_Rubro=".$Id_Rubro."&Rubro=".$Rubro."&Id_SubRubro=".
                    $Id_SubRubro."&SubRubro=".$SubRubro ?>">
