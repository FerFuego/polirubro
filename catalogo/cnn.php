...
function ConsultarID_Pedido($Id_Cliente)
{
	global $cnn;
...
function ConsultarCodExistente($Id_Pedido, $CodProducto)
{
	global $cnn;
...
function ArrayDetallePedido($Id_Pedido)
{
	global $cnn;
...
function BorrarProductoDetallePedido($Id_Pedido, $Id_Producto)
{
	global $cnn;
...
function CerrarPedido($Id_Pedido)
{
	global $cnn;
	$FechaFin = date ("Y-m-d");
