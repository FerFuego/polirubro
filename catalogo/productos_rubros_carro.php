...
$filtro = "&Id_Rubro=".$Id_Rubro."&Rubro=".$Rubro."&Novedad=".$Novedad."&Oferta=".$Oferta."&Pagina="."productos_rubros_carro.php";
...
$sql = "SELECT * FROM productos WHERE Id_Producto > 0 $c_criterio ORDER BY Rubro, SubRubro, Grupo, Nombre";
    ...
    <div class="container" style="background-color: #FFF;">
        ...
        <div class="row">
            <div align="center" class="col-md-12">
                <h2>PRODUCTOS en <?php echo $Rubro ?></h2>
            </div>
        </div>
        ...
        if ($enviado != false)
        {
            ...
            else
            {
                ...
                while ($dato = mysqli_fetch_array ($rsProductos))
                {
                    ...
                    echo "<h6>En: ".$dato["Rubro"]." | ".$dato["SubRubro"]." | ".$dato["Grupo"]."</h6>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                    if ($col == 4)
        ...
        <div class="row">
            <div align="center" class="col-md-12">
                <p>
                <?php
                //Si la cantidad de páginas es menor o igual, armo el link Anterior.
                if ($pagina > 1)
                {
                    // Paso la página anterior y el sql.
                    $pag_ant = $pagina - 1;
                    echo "<a href='productos_rubros_carro.php?pagina=$pag_ant&cant_reg=$cant_reg&cant_pag=$cant_pag&Buscar=Buscar&Id_Rubro=".$Id_Rubro."&Rubro=".$Rubro."'>
                    <button name='cmdAnterior' type='button' class='btn btn-success' value='Anterior'>Anterior</button>
                    </a>";
                }
                $pagina ++;	
                // Si la cantidad de páginas es mayor o igual, armo el link Siguiente.
                if ($cant_pag >= $pagina)
                {
                    // Paso la página siguiente y el sql.
                    echo "<a href='productos_rubros_carro.php?pagina=$pagina&cant_reg=$cant_reg&cant_pag=$cant_pag&Buscar=Buscar&Id_Rubro=".$Id_Rubro."&Rubro=".$Rubro."'>
