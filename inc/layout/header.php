        ...
        <ul>
            ...
            <?php if (Polirubro::is_Admin()): ?>
                <li><a href="cpanel.php"
                        class="<?php echo (!isset($opcion) || $opcion == '') ? 'active' : ''; ?> item">Dashboard</a></li>
                <li><a href="cpanel.php?opcion=importar"
                        class="<?php echo (isset($opcion) && $opcion == 'importar') ? 'active' : ''; ?> item">Importar
                        Productos</a></li>
                <li><a href="cpanel.php?opcion=productos"
                        class="<?php echo (isset($opcion) && $opcion == 'productos') ? 'active' : ''; ?> item">Gestion de
                        Productos</a></li>
                <li><a href="cpanel.php?opcion=clientes"
                        class="<?php echo (isset($opcion) && $opcion == 'clientes') ? 'active' : ''; ?> item">Gestion de
                        Clientes</a></li>
                <li><a href="cpanel.php?opcion=banners"
                        class="<?php echo (isset($opcion) && $opcion == 'banners') ? 'active' : ''; ?> item">Gestion de
                        Banners</a></li>
                <li><a href="cpanel.php?opcion=categories"
                        class="<?php echo (isset($opcion) && $opcion == 'categories') ? 'active' : ''; ?> item">Gestion de
                        Categorias</a></li>
            <?php endif; ?>
        </ul>
    </nav>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="header__top__right">
                        <?php if ($general->facebook || $general->instagram || $general->twitter): ?>
                            <div class="header__top__right__social">
                                <?php if ($general->facebook): ?>
                                    <a href="<?php echo $general->facebook; ?>" targte="_blank"><i
                                            class="fa fa-facebook"></i></a>
                                <?php endif; ?>
                                <?php if ($general->instagram): ?>
                                    <a href="<?php echo $general->instagram; ?>" targte="_blank"><i
                ...
                <nav class="header__menu">
                    <ul>
                        ...
                        <li class="<?php echo (Polirubro::normalize_title() === 'Contacto') ? 'active' : '' ?>"><a
                                href="./contacto.php">Contacto</a></li>
                        <?php if (Polirubro::is_Admin()): ?>
                            <li class="<?php echo (Polirubro::normalize_title() === 'CPanel') ? 'active' : '' ?>"><a
                                    href="./cpanel.php">Admin</a></li>
                        <?php endif; ?>
                    </ul>
                </nav>
            </div>
